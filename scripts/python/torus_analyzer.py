...
if __name__ == "__main__":
  ...
  parser.add_argument('--no_figs', type=bool, default=False, help='Whether to disable image creation')
  parser.add_argument('--no_logs', type=bool, default=False, help='Whether to disable log creation')
  parser.add_argument('--no_avgs', type=bool, default=False, help='Whether to disable averages creation')
  parser.add_argument('--overwrite', action='store_true', help='Whether to overwrite existing outputs')

  parser.add_argument('--rout', type=float, default=40., help='Outer radius to plot for images')

  parser.add_argument('--serial', dest='serial', default=False, action='store_true', help='Run in serial')
  parser.add_argument('--nproc', dest='nproc', default=None, type=int, help='Number of parallel processes to use. Defaults to all available cores.')

  parser.add_argument('directory', type=str, help='Directory containing simulation output')
  parser.add_argument('--problem_name', type=str, default='torus.out1', help='Name of problem for output file')
  ...
  if args.serial:
    ...
    p.starmap(process_file, zip(filenames, repeat(fig_folder), repeat(log_folder), repeat(avg_folder)))
