...
parser.add_argument('--a0', type=float, default=1,
                    help="Initial value of scale factor a")
parser.add_argument('--dadt', type=float, default=1,
                    help="Time derivative of scale factor a")
parser.add_argument('--savename', type=str, default='flrw.png',
                    help='Name to save plot to')
parser.add_argument('files', type=str, nargs='+',
                    help='Files to use for time evolution')
def get_rho_adm(f):
