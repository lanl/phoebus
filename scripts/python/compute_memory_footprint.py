...
def compute_footprint(nb,nx1,nx2,nx3):
    ...
    indep_3d_nums = tot_indep_vars*(nums_per_3d_var*stages + nums_per_3d_var*nfaces + nums_per_ghost_halo)
    ...
    dep_3d_nums = (1 + 1 + 3 + 3 + 3 + tot_indep_vars*(3 + 3) + 1 + 3 + 1 + 3 +1 + 1 + 1 + 1 + 1 + 4)*nums_per_3d_var
...
if __name__ == "__main__":
    ...
    parser.add_argument("NB", type=int,
                        help="Number of meshblocks")
    parser.add_argument("NX", type=int, nargs=3,
                        help="Meshblock size. Requires 3 integers.")
