...
void ProblemGenerator(MeshBlock *pmb, ParameterInput *pin) {
  ...
  pmb->par_for(
      "Phoebus::ProblemGenerator::JankaLightbulb", kb.s, kb.e, jb.s, jb.e, ib.s, ib.e,
      KOKKOS_LAMBDA(const int k, const int j, const int i) {
        ...
        v(igm1, k, j, i) = eos.BulkModulusFromDensityTemperature(v(irho, k, j, i), v(itmp, k, j, i), lambda) /v(iprs, k, j, i);
        v(iye, k, j, i) = Ye0;
